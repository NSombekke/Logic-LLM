...
We test the LLms ability to parse natural language into LTL on two datasets. The first consists of 36 benchmark inctances crafted by experts in the *nl2spec* study [5]. Each of these examples has been selected by LTL experts to cover a variety of ambiguities and complexities. In *nlspec in NL* we have replaced the propositions a,b,c,d to create more realistic sentences in natural language. For example:
